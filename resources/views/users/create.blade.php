                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.staffs.store') }}">
                        ...
                        <div class="form-group bmd-form-group">
                            ...
                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="" required autocomplete="name">
                            @error('name')
                        ...
                        <div class="form-group bmd-form-group">
                            ...
                            <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="" required autocomplete="email">
                        ...
                        <div class="form-group bmd-form-group">
                            ...
                            <input id="address" type="text" class="form-control @error('text') is-invalid @enderror" name="address" value="" required autocomplete="email">
