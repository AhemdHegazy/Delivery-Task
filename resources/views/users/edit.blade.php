    ...
    <div class="row justify-content-center">
        <div class="col-md-7">
            <div class="card ">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.staffs.update') }}">
                        @csrf
                        ...
                        <div class="form-group bmd-form-group">
                            ...
                            <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ $user->phone }}" required autocomplete="email">
                        ...
                        <div class="form-group bmd-form-group">
                            ...
                            <input id="address" type="text" class="form-control @error('text') is-invalid @enderror" name="address" value="{{  $user->address }}" required autocomplete="email">
                        ...
                        <input type="hidden"  value="{{$user->lat}}" id="latitude" name="lat">
                        <input type="hidden" value="{{$user->lng}}" id="longitude"  name="lng">
